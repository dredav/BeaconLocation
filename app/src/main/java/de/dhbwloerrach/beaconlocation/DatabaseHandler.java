...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + TABLE_MACHINE + "(" + KEY_MACHINE_ID + " INTEGER PRIMARY KEY UNIQUE AUTOINCREMENT," + KEY_MACHINE_NAME + " VARCHAR)");
        db.execSQL("CREATE TABLE " + TABLE_BEACON + "(" + KEY_BEACON_ID + " INTEGER PRIMARY KEY UNIQUE AUTOINCREMENT," + KEY_BEACON_MINOR + " INTEGER," + KEY_BEACON_MAJOR + " INTEGER," + KEY_BEACON_UUID + " VARCHAR," + KEY_BEACON_MACHINEID + " INTEGER)");
    ...
    public void deleteBeacon(Beacon beacon) {
        SQLiteDatabase db = getWritableDatabase();
        db.delete(TABLE_BEACON, KEY_BEACON_MINOR + "=?", new String[]{String.valueOf(beacon.getMinor())});
        db.close();
    }
    ...
    public int updateBeacon(Beacon beacon) {
        ...
        int rowsAffected = db.update(TABLE_BEACON, values, KEY_BEACON_ID + "=?", new String[] { String.valueOf(beacon.getId()) });
        db.close();
